...
SysResult_t PermStorageMngrStreamRegister(PermStorageHandle_t handle, Id_t stream_ringbuf);

SysResult_t PermStorageMngrStore(PermStorageHandle_t handle, U8_t *data, U32_t offset, U32_t size);

SysResult_t PermStorageMngrLoad(PermStorageHandle_t handle, U8_t *data, U32_t offset, U32_t size);
